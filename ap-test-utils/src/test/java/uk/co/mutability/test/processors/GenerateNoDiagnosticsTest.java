...
/**
 * A test for VerifyingProcessor for the case where no diagnostics at all are generated.
 */
@VerifyDiagnostics(uk.co.mutability.test.processors.ComplainingProcessor.class)
public class GenerateNoDiagnosticsTest extends AbstractDiagnosticsTest {
    /* Nothing. */
}
