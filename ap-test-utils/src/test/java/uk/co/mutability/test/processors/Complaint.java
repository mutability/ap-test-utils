...
/**
 * An annotation inspected by {@link ComplainingProcessor} to generate diagnostics.
 */
public @interface Complaint {
	/** The message to complain about in a diagnostic */
	String value();
	
	/** The kind of diagnostic to generate */
	Diagnostic.Kind kind() default Diagnostic.Kind.ERROR;
	
	/** Whether to omit the source element in the diagnostic */
	boolean omitElement() default false;
}
